        ...
        .then(userDoc => {
            ...
            attend.forEach(thisEventID => {
                ...
                db.collection("events").doc(thisEventID).get().then(doc => {
                    ...
                    newcard.querySelector('#startTime').innerHTML = "Start Time: "+ startTime.toDate().toLocaleString("en-US", formatOptions);;
                    newcard.querySelector('#endTime').innerHTML = "End Time: " + endTime.toDate().toLocaleString("en-US", formatOptions);;
                    newcard.querySelector('#participants').innerHTML = "Number of Participants: "+ participants;
